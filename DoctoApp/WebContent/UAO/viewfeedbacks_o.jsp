                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <span class="educate-icon educate-charts icon-wrap"></span> <span class="mini-click-non">FeedBacks</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">View Feeds</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Your <span class="table-project-n">Valuable</span> Feeds</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Rate</th>
                                                <th data-field="email" data-editable="true">Feedbacks</th>
									...
									Query q1 = HibernateTemplate.select("from feedback f order by f.posteddate desc");
									List lst1 = q1.list();
                                    ...
                                    while (it1.hasNext())
                                    {
                                    	feedback fobj = (feedback)it1.next();
                                    %>
                                            ...
                                            <tr>
                                            	...
                                            	<td><%=++i %></td>
                                                <td><%=fobj.getRate() %></td>
                                                <td><%=fobj.getDescrp() %></td>
                                                <td><%=fobj.getPosteddate() %></td>
                                                <td class="datatable-ct">
                                            		<a href="delete.aks?id=<%=fobj.getRid() %>">
