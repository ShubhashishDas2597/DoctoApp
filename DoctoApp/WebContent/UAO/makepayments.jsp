                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Make Payments</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                      <form method="post" action="pgRedirect.aks">
                                                        <div class="form-group">
                                                       	    <label>ORDER_ID::*</label> 
                                                       	    <input id="ORDER_ID" class="form-control" tabindex="1"
																maxlength="20" size="20" name="ORDER_ID"
																autocomplete="off" readonly="readonly" value="ORDS_<%=randomInt%>">
                                                        </div>
                                                        <div class="form-group">
                                                        	<label>Appointment ID ::*</label> 
                                                        	<%
                                                        	Query q1 = HibernateTemplate.select("select a.aid from appointment a where a.pid = :x and a.payment like 'not' ");
                                                        	int pat = (int) session.getAttribute("pid");
                                                        	q1.setParameter("x", pat);
                                                        	List lst1 = q1.list();
                                                        	Iterator it1 = lst1.iterator();
                                                        	%>
                                                        	<select	id="CUST_ID" name="CUST_ID" class=" form-control" tabindex="-1">
																<option hidden>---Appointment ID---</option>

																<%
																	while (it1.hasNext()) {
																		Integer id = (Integer)it1.next();
																%>
																<option value="<%=id.intValue()%>"><%=id.intValue()%></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="INDUSTRY_TYPE_ID" tabindex="4" maxlength="12" size="12" class="form-control"
                                                            readonly="readonly" name="INDUSTRY_TYPE_ID" autocomplete="off" value="DoctoApp">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Channel ::*</label> 
                                                            <input id="CHANNEL_ID" tabindex="4" maxlength="12" size="12" readonly="readonly"
															  class=" form-control" name="CHANNEL_ID" autocomplete="off" value="WEB">
														</div>
														<div class="form-group">
                                                            <label>txnAmount*</label> 
                                                            <input title="TXN_AMOUNT" tabindex="10" type="text" readonly="readonly"
															 class=" form-control" name="TXN_AMOUNT" value="200">
														</div>
														<div class="form-group">
                                                            <input value="CheckOut" type="submit" class="form-control" onclick="">
														</div>
														</form> 
...
<!-- ================================================================customizations end================== -->       
   ...
   <!-- morrisjs JS
    ...
    <!-- payment away JS
		============================================ -->
    <script src="js_main/card.js"></script>
    <script src="js_main/jquery.payform.min.js"></script>
    <script src="js_main/e-payment.js"></script>
    <!-- plugins JS
		============================================ -->
