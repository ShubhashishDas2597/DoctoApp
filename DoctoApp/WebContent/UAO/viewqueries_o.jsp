                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">View Queries</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1> <span class="table-project-n">Queries</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Subject</th>
                                                <th data-field="email" data-editable="true">Message</th>
                                                <th data-field="phone" data-editable="true">Date_time</th>
									...
									Query q1 = HibernateTemplate.select("from contact c order by c.date_time desc");
									List lst1 = q1.list();
                                    ...
                                    %>
                                            ...
                                            <tr>
                                            	...
                                            	<td><%=cobj.getName() %></td>
                                            	<td><%=cobj.getEmail()%></td>
                                                <td><%=cobj.getSubject() %></td>
                                                <td><%=cobj.getMess() %></td>
                                                <td><%=cobj.getDate_time() %></td>
                                                <td class="datatable-ct">
                                            		<a href="emailing.aks?cid=<%=cobj.getCid() %>">
                                            		<button data-toggle="tooltip" title="Reply" class="pd-setting-ed" type="submit">
                                            			Reply
                                            		</button>
                                            		</a>
                                                </td>
