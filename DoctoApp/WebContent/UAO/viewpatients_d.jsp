                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1> <span class="table-project-n">Patients</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
									...
									Query q1 = HibernateTemplate.select("from appointment a where a.did = :x and a.payment not like 'not' order by a.takendate desc");
									q1.setParameter("x", (int) session.getAttribute("doctid"));
									//q1.setParameter("y", "unattended");
									List lst1 = q1.list();
