                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="viewqueries_o.aks">Queries</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Emailing</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline14-list">
                            ...
                            <form action="reply.aks" method="post">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="hex">
													...
													<input type="email" id="hex" name="email" required="required" value="<%=c.getEmail() %>" readonly="readonly">
												</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="colorpicker-inner ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="rgb">
														<input type="text" id="" name="subj" required="required" >
													</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="colorpicker-inner ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="rgb">
													<textarea required="required" name="mess" id="rgb" cols="20" style="height: 200px"></textarea>
												</label>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="input-group">
                                     <input type="submit" class="form-control" value="Send Email"style="color: green;" >
                                   </div>
                                 </div>
                                </form>
                            </div>
