                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                List lst1 = q1.list();
                                %>
                                <h2>&#8377;<span class="counter"><%=200 * lst1.size() %></span> <span class="tuition-fees">Total Paid Money</span></h2>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Appointments</h5>
                                <%
                                Query q2 = HibernateTemplate.select("from appointment a where a.pid = :x and a.date_time >= :y ");
                                q2.setParameter("x", (int) session.getAttribute("pid"));
                                q2.setParameter("y", Date_format.tareek());
                				
                				List lst2 = q2.list();
                				
                                %>
                                <h2><span class="counter"><%=lst2.size() %></span> <span class="tuition-fees">Upcoming Appointments</span></h2>
                                <span class="text-danger">*Inclusive All Department(Paid + Non Paid Appointments)</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-sales-chart">
                            ...
                            <%
								...
								Query qm = s.createQuery("select count(a.pid), a.takendate from appointment a  where a.pid = :x and a.payment not like 'not' group by a.takendate");
								qm.setParameter("x", (int) session.getAttribute("pid"));
								List lm = qm.list();
                        ...
                        <div class="product-sales-chart">
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Your Appointments</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="price">S.No.</th>
                                                <th data-field="id">Doctor</th>
                                                <th data-field="name" data-editable="true">Appointment Id</th>
                                                <th data-field="email" data-editable="true">Appointment Date</th>
                                                <th data-field="phone" data-editable="true">Taken Date</th>
									...
									Query q3 = HibernateTemplate.select("from appointment a where a.pid = :x and a.date_time = :y order by a.date_time desc");
									q3.setParameter("x", session.getAttribute("pid"));
									q3.setParameter("y", Date_format.tareek());
									List lst3 = q3.list();
                                    ...
                                    while (it3.hasNext())
                                    {
                                    	appointment a = (appointment) it3.next();
										Object  o = HibernateTemplate.findOperation(doctor.class, a.getDid()); 
										doctor d =  (doctor) o ;
										String tareek = Date_format.tareek();
                                    ...
                                    %>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=a.getStatus().toString().toUpperCase() %></td>
                                            </tr>
                                    <%
                                    }
                                    %>
