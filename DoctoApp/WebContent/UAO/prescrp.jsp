                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="dashboard_d.aks">Dashboard 
                                        </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Write Prescription</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1> <span class="table-project-n">Prescription</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                ...
                                <%
          						...
          						%>
                                <form action="writepres.aks?aid=<%=a.getAid()  %>" method="post">
          <!-- -------------------static table------------------------- -->
                                     <table class="table">
                                        <thead>
                                            <tr style="color: green;">
                                                <th class="col-sm-2">Appointment ID: <%=a.getAid() %></th>
                                                <th class="col-sm-2">Patient Name: <%=p.getPname().toString().toUpperCase() %></th>
                                                <th class="col-sm-2">Age: <%=p.getAge() %></th>
                                                <th class="col-sm-2">Gender: <%=p.getSex().toString().toUpperCase() %></th>
                                                <th class="col-sm-2">Taken Date: <%=a.getTakendate() %></th>
                                                <th class="col-sm-2"><input type="submit" class="form-control btn btn-success" /></th>
                                            </tr>
                                        </thead>
                                     </table>
                                     <table id="myTable" class="table">
                                     	<tbody>
                                     		<tr>
                                     			<th class="col-sm-4">Medicines</th>
                                     			<th class="col-sm-4">Days</th>
                                     			<th class="col-sm-4">No. of times per day</th>
                                     		</tr>
                                     		<tr>
                                     			<!-- <th class="col-sm-4"><input type="text" name="medcn" class="form-control" placeholder="Medicine Name"  autofocus required/></th>
                                     			<th class="col-sm-4"><input type="number" name="days" class="form-control" placeholder="No of Days" min= "1" autofocus required/></th>
                                     			<th class="col-sm-4"><input type="number" name="times" class="form-control" placeholder="times" min= "1" autofocus required/></th>
                                     		 -->
                                     		 <th class="col-sm-12" colspan="3"><textarea name="medcn" rows="10" style="height: 200px; resize: none;" class="form-control" required></textarea></th>
                                     		 </tr>
                                     	</tbody>
                                     </table>
                                     
                                     <!-- <button onclick="myDeleteFunction()" class="btn btn-custon-two btn-danger">Delete row <i class="fa fa-minus-circle"></i></button>
									 <button onclick="myCreateFunction()" class="btn btn-custon-two btn-primary">Create row <i class="fa fa-plus-circle"></i></button>
									...
									function myCreateFunction() {
									    ...
									    cell1.innerHTML = "<input type='text' name='medcn' class='form-control' placeholder='Medicine Name'  autofocus required/>";
									    cell2.innerHTML = "<input type='number' name='days' class='form-control'  placeholder='No of Days' min= '1' autofocus required/>";
									    cell3.innerHTML = "<input type='number' name='times' class='form-control'  placeholder='times' min= '1' autofocus required/>";
									}
									...
									<%
									Query q1 = HibernateTemplate.select("from appointment a where a.date_time = :x and a.did = :y and a.payment not like 'not' ");
                                    ...
                                    %>
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">
                                            		<a href="prescrp.aks?aid=<%=fobj.getAid() %>">
