                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">View Appointments</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Your <span class="table-project-n">Appointments</span></h1>
                                </div>
                            </div>
                                    ...
                                    data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="price" data-editable="true">Appointment Id</th>
                                        ...
                                        <tbody>
                                    <%
									Query q1 = HibernateTemplate.select("from appointment a where a.pid = :x order by a.date_time desc");
									q1.setParameter("x", session.getAttribute("pid"));
									List lst1 = q1.list();
									Iterator it1 = lst1.iterator();
									while (it1.hasNext()) 
									{
										appointment a = (appointment) it1.next();
