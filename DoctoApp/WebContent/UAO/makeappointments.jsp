            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="hex">
														<input type="text" id="hex" value="<%=session.getAttribute("pname").toString().toUpperCase() %>" readonly="readonly">
													</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="colorpicker-inner ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="rgb">
														<input type="text" id="rgb" value="<%=session.getAttribute("pmob") %>" readonly="readonly">
													</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="colorpicker-inner ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="palette1">
														<input type="text" id="palette1" value="<%=session.getAttribute("page") %>" readonly="readonly">
													</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="colorpicker-inner ts-forms mg-b-23">
                                            <div class="tsbox">
                                                ...
                                                <label class="color-group" for="a-hsl">
														<input type="text" id="a-hsl" value="<%=session.getAttribute("psex") %>" readonly="readonly">
													</label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form action="addapp.aks" method="post">
                                ...
                                <div class="date-picker-inner">
                                    <div class="form-group data-custon-pick" id="data_1">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="date" class="form-control" required="required" name="appdate" min="<%=df.format(cal1.getTime()) %>" max="<%=df.format(cal.getTime())%>">
                                        </div>
                                    </div>
