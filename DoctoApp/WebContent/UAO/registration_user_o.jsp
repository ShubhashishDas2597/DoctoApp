    ...
    <div class="page-wrapper bg-gra-03 p-t-100 p-b-50"  style="background: #2f89fc; background-image: linear-gradient(to bottom right,#04091e, #1AD5B0);">
        <div class="wrapper wrapper--w900" style="max-width: 1000px;">
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form method="POST" action="addpatient_o.aks">
                        <div class="form-row">
                            <div class="name">Full name</div>
                            <div class="value">
                                <input class="input--style-6" type="text"  onkeypress="checkname()" id ="name" name="name" required="required" placeholder="PATIENT NAME">
                            </div>
                        </div>
                        <div class="form-row">
